...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'Student Information Management REST API (Laravel 12 + Laravel Sanctum). '
            ...
            .'Responses use a consistent envelope: `{success, message, data}` on success, and '
            .'`{success: false, message, errors}` on validation errors.',
    ],
